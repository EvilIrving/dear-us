...
## Product
- **Name:** 耳语 / Between us
- **One-liner:** 把两个人的心意，放进共同养着的三个容器。
- **What it does:** 耳语是一款原生 iOS 双人关系应用。两个人可以把文字、图片、视频和语音放进共同的星星瓶、胶囊盒与纸团篓，容器会随着双方留下的内容逐渐变化。它不使用聊天时间线、任务、金币或连续签到，而是通过写、折、封、揉、按住与放入等动作，让表达更像一件被认真留下的东西。
...
## Pricing model
- 免费版的共同空间最多同时保留 10 条内容，按双方在三个容器中的当前内容总数计算；删除单条内容或清空全部内容后会立即释放额度。
- 只提供一次性永久买断，不提供任何订阅。买断后取消内容数量上限。
- 一人购买后，两人所在的共同空间同时解锁。
- 确认首发价格：中国区 ¥18，海外以美国区 US$2.99 为基准使用 App Store 对等价格。
- 当前构建尚未接入 StoreKit、买断权益同步与额度拦截；公开页面在实现完成前不得把买断描述为已上线能力。
...
- **Words to use / avoid:** 使用“放进去”“共同房间”“容器发生了变化”“留下一件东西”；避免“发送”“收到消息”“回复”“未读”“打卡”“连续天数”“养成任务”。中文不滥用破折号，英文不用 em dash。
